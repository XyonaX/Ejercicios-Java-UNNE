public class Comercio {
        public static void main(String[] args) {
                ...
                System.out.printf("Cuotas: %d - Interes: %.2f%%", cuotas, interes);
                System.out.printf("\nValor Cuota: $%.2f\nValor Cuota Con Adicionales: $%.2f\n",
                                heladera1.cuotaCredito(cuotas, interes),
                                heladera1.creditoConAdicional(cuotas, interes));
                lavarropas1.imprimir();
                System.out.printf("Cuotas: %d - Interes: %.2f%%", cuotas, interes);
                System.out.printf("\nValor Cuota: $%.2f\nValor Cuota Con Adicionales: $%.2f\n",
                                lavarropas1.creditoConAdicional(cuotas, interes),
                                lavarropas1.cuotaCredito(cuotas, interes));
        }
}
