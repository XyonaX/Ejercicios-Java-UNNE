...
/**
 * Crea y manipula un objeto de tipo Laboratorio.
 * 
...
public class Persona {
    ...
    /**
     * Inicializa los atributos por parametro.
     * 
     ...
     * @param p_apellido        String;
     * @param p_dni             int;
     * @param p_fechaNacimiento Calendar;
     */
    ...
    // Fin Accessors
    /**
     * Calcula la edad de la persona en calendario gregoriano.
     * 
    ...
    /**
     * Muestra por pantalla el nombre, apellido, DNI y edad de la persona.
     */
    public void mostrar() {
     ...
     * 
     * @return verdadero o falso segun la verificacion.
     */
